...
fun normalizeIemState(state: IemState): IemState {
    ...
    return state.copy(
        ...
        decoder = state.decoder.copy(
            downmix = state.decoder.downmix.copy(
                lsDelayUs = state.decoder.downmix.lsDelayUs.coerceIn(0, 32000),
                rsDelayUs = state.decoder.downmix.rsDelayUs.coerceIn(0, 32000),
                lsrDelayUs = state.decoder.downmix.lsrDelayUs.coerceIn(0, 32000),
                rsrDelayUs = state.decoder.downmix.rsrDelayUs.coerceIn(0, 32000),
                sideShelfFrequencyMillionths = state.decoder.downmix.sideShelfFrequencyMillionths.coerceIn(0, 1000000),
                sideShelfGainMillionths = state.decoder.downmix.sideShelfGainMillionths.coerceIn(0, 1000000),
                rearShelfFrequencyMillionths = state.decoder.downmix.rearShelfFrequencyMillionths.coerceIn(0, 1000000),
                rearShelfGainMillionths = state.decoder.downmix.rearShelfGainMillionths.coerceIn(0, 1000000),
                panLeftMillionths = state.decoder.downmix.panLeftMillionths.coerceIn(0, 1000000),
                panRightMillionths = state.decoder.downmix.panRightMillionths.coerceIn(0, 1000000),
                centerDivergenceMillionths = state.decoder.downmix.centerDivergenceMillionths.coerceIn(0, 1000000),
                frontMidTrimMillionths = state.decoder.downmix.frontMidTrimMillionths.coerceIn(0, 1000000),
                frontSideTrimMillionths = state.decoder.downmix.frontSideTrimMillionths.coerceIn(0, 1000000),
                centerTrimMillionths = state.decoder.downmix.centerTrimMillionths.coerceIn(0, 1000000),
                surroundMidTrimMillionths = state.decoder.downmix.surroundMidTrimMillionths.coerceIn(0, 1000000),
                surroundSideTrimMillionths = state.decoder.downmix.surroundSideTrimMillionths.coerceIn(0, 1000000),
                rearMidTrimMillionths = state.decoder.downmix.rearMidTrimMillionths.coerceIn(0, 1000000),
                rearSideTrimMillionths = state.decoder.downmix.rearSideTrimMillionths.coerceIn(0, 1000000),
                lfeTrimMillionths = state.decoder.downmix.lfeTrimMillionths.coerceIn(0, 1000000),
                lfeLpfFrequencyMillionths = state.decoder.downmix.lfeLpfFrequencyMillionths.coerceIn(0, 1000000),
                outputHpfFrequencyMillionths = state.decoder.downmix.outputHpfFrequencyMillionths.coerceIn(0, 1000000),
                outputLeftTrimMillionths = state.decoder.downmix.outputLeftTrimMillionths.coerceIn(0, 1000000),
                outputRightTrimMillionths = state.decoder.downmix.outputRightTrimMillionths.coerceIn(0, 1000000),
            ),
        ),
        freeze = false,
    )
