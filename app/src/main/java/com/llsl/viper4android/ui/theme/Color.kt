...
val ViperInkLight = Color(0xFF191A1E)
val ViperInkDark = Color(0xFFF6F7F9)
val ViperSecondaryInkLight = Color(0xFF6B6E78)
val ViperSecondaryInkDark = Color(0xFFA0A3AF)
